...
if submitted:
    ...
    if score == 5:
        ...
        st.write("สร้างโดยนายธีรภัทร ยามวงศ์ เลขที่ 4 ม.4/2 
        นายอินทรัตน์  สิงห์แก้ว เลขที่6 ม.4/2 
        นายสิรภพ ฝั้นถาวร เลขที่12 ม.4/2 
        นายตฤนภัทร แสงปรีดานนท์ เลขที่39 ม.4/2")
